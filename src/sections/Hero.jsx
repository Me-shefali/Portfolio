                    ...
                    <div className="space-y-8 ">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                                Hi, I'm Shefali Chouhan. I am an Engineering student specializing in Artificial Intelligence and Data Science, passionate about building practical, meaningful, and learning-oriented tech projects.
                            </p>
                        </div>
